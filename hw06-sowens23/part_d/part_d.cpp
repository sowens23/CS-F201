...
int main () {
	...
	// If birthday == today
	if (birthday.getMonth() == today.getMonth() & birthday.getDay() == today.getDay()) {	// Yali: use &&
	...
	else if (birthday.getMonth() == today.getMonth() & birthday.getDay() < today.getDay()) {	// Yali: use &&
